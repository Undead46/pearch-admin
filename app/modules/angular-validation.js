    ...
    angular.module('validation.provider', [])
        .provider('$validation', function() {
            ...
            this.getErrorHTML = function(message) {
                return '<div class="alert alert-danger"><button type="button" class="close">x</button>'+ message +'</div>'
            };
            ...
            this.getSuccessHTML = function(message) {
                return '<div class="alert alert-success"><button type="button" class="close"">x</button>'+ message +'</div>'
            };
            ...
            function($injector) {
                ...
                var validFunc = function(element, validMessage, validation, scope, ctrl) {
                    ...
                    if(!element.parent().hasClass('has-feedback')) {
                        element.wrap('<div class="has-success has-feedback">').after('<i class="glyphicon glyphicon-ok form-control-feedback" aria-hidden="true"></i>');
                    }else {
                        element.parent().removeClass('has-error').addClass('has-success');
                        element.parent().find('i').removeClass('glyphicon-remove').addClass('glyphicon-ok');
                    }
                ...
                var invalidFunc = function(element, validMessage, validation, scope, ctrl) {
                    ...
                    if(element.parent().hasClass('has-feedback')) {
                        ...
                        element.parent().find('i').removeClass('glyphicon-ok').addClass('glyphicon-remove');
                    }
                    ...
                    if ($validationProvider.showErrorMessage && messageToShow) {
                        ...
                        element.parent().next().find('button').on('click', function(){
                            if(angular.element(this).hasClass('close')) {
                                element.parent().next().remove();
                                element.parent().removeClass('has-error');
                                element.parent().find('i').removeClass('glyphicon-remove');
                            }
                        });
        ...
        .directive('validationSubmit', ['$injector',
            function($injector) {
                ...
                return {
                    ...
                    require: '?ngClick',
                    link: function postLink(scope, element, attrs, ctrl, validation, value) {
